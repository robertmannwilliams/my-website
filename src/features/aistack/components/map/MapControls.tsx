...
export function MapControls({
  ...
  return (
    <div className="fixed right-3 top-3 z-10 flex max-w-[calc(100vw-4.5rem)] flex-col items-end gap-2">
      <div className="flex items-center gap-1 rounded-full border border-border/80 bg-card/90 p-1 text-foreground shadow-[0_14px_34px_rgba(90,72,48,0.14)] backdrop-blur">
        <button
          type="button"
      ...
      {chokepointMode && (
        <aside className="max-w-[17rem] rounded-xl border border-accent/20 bg-card/92 px-4 py-3 text-right text-foreground shadow-[0_16px_36px_rgba(90,72,48,0.14)] backdrop-blur">
          <p className="font-ui text-[10px] uppercase tracking-[0.2em] text-accent">
            Chokepoint view
          </p>
          <p className="font-body mt-1 text-sm leading-snug text-foreground/72">
            Monopoly and duopoly sites stay bright; diversified suppliers fade
            back.
          </p>
        </aside>
      )}
